...
import MintAriaPage from './pages/MintAriaPage'; 
import OracleDashboard from './pages/OracleDashboard';
import GovernancePage from './pages/GovernancePage';
import YieldDashboard from './pages/YieldDashboard'; // ← Added
// Component Imports
      ...
      <VStack spacing={6} align="stretch">
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              account ? (
                <YieldDashboard provider={provider} address={account} />
              ) : (
                <VStack spacing={4} py={8}>
                  <Heading size="md" textAlign="center">
                    Please connect your wallet to view yield dashboard.
                  </Heading>
                </VStack>
              )
            }
